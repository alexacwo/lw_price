    ...
    <div class="product-desc">
      ...
      <p>
          <?php 
            ...
            ?>
            <?php echo strip_shortcodes($display_content); ?><a class="view-more-link" href="<?php echo get_permalink($post->ID); ?>"><?php _e('View more', 'framework'); ?></a>
      </p>
      <div class="reviews">
...
<?php } else { // If "post" or any other post type ?>
                                                                                                                                                      
<!-- Product <?php echo $itotal; ?> begin -->
<div class="product">
    <div class="product-photo">
        <?php if (function_exists('has_post_thumbnail') && has_post_thumbnail() ): ?>        
            <?php the_post_thumbnail('product-photo'); ?>
        <?php else: ?>
            <img src="<?php echo  ( isset($post->post_type) && $post->post_type == 'product' ? get_template_directory_uri()."/img/no-photo.png" : get_template_directory_uri()."/img/no-photo-post-page.png"); ?>" alt="<?php echo esc_attr(get_the_title()); ?>" />
        <?php endif; ?>
    </div>
    ...
    <div class="product-view">
      <div class="medium primary btn metro rounded">
        <a href="<?php echo get_permalink($post->ID); ?>"><?php _e('Read More', 'framework'); ?></a>
      </div>
    </div>
</div>
<!-- Product <?php echo $itotal; ?> end -->
